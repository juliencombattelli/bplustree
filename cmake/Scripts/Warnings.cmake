...
function(target_project_warnings TARGET_NAME)
    ...
    option(BPLUSTREE_WARNINGS_GCC_EXTRA_${TARGET_NAME} "Add extra GCC warnings not supported by Clang" ON)
    option(BPLUSTREE_WARNINGS_ALL_${TARGET_NAME} "Add a large set of compiler warnings" ON)
    option(BPLUSTREE_WARNINGS_AS_ERRORS_${TARGET_NAME} "Treat compiler warnings as errors" OFF)

    if (BPLUSTREE_WARNINGS_ALL_${TARGET_NAME})
        set(MSVC_WARNINGS
    ...
    if (BPLUSTREE_WARNINGS_AS_ERRORS_${TARGET_NAME})
    ...
    if (BPLUSTREE_EXTRA_GCC_WARNINGS_${TARGET_NAME})
